...
const tourismFaqs = [
  ...
  },
  {
    ...
    answer: 'The consultation fee with Dr Rajesh Goel is $25 USD for international patients. For patients in India, it starts from ₹500. This includes a comprehensive evaluation and personalized treatment plan.',
  },
  {
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: '💰', title: 'Affordable Costs', desc: 'Kidney treatment costs 60-80% less than US, UK, or Australia. Consultation fee is just $25 USD for international patients.' },
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: 'Online Video Consultation', desc: 'Get expert advice from Dr Rajesh Goel from the comfort of your home. Comprehensive evaluation, treatment plans, and follow-up guidance.', price: '$25 USD' },
              ...
              { title: 'Second Opinion Services', desc: 'Get a second opinion from an experienced nephrologist for complex kidney cases or treatment decisions.', price: '$25 USD' },
            ].map((item, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: '1', title: 'Book Online', desc: 'Choose your preferred date and time. Pay consultation fee of $25 USD.' },
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-200">
                  {[
                    { treatment: 'Online Consultation', india: '$25 USD', us: '$200-500', savings: '90-97%' },
