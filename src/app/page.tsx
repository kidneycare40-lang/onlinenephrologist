...
const faqs = [
  ...
  { question: 'Can international patients consult online?', answer: 'Absolutely. Dr Rajesh Goel regularly consults with international patients from the USA, UK, UAE, Singapore, and other countries. The consultation fee for international patients is $25 USD. We can coordinate across time zones and provide treatment plans that can be followed locally with your referring physician.' },
