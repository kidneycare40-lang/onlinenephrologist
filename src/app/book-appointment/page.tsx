        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 md:py-10">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-3 md:gap-6">
            ...
            <div className="text-center md:text-left min-w-0 flex-1">
              ...
              <p className="text-white/80 text-xs sm:text-sm md:text-base">Consult <Link href="/dr-rajesh-goel" className="text-white font-semibold hover:text-white/80 transition-colors">Dr Rajesh Goel</Link>
