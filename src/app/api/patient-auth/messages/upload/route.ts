...
import { requirePatientAuth } from '@/lib/patient-messages-server';
...
export async function POST(request: NextRequest) {
  try {
    ...
    await ensureBucket();
    const db = getDb();
    const folder = auth.patientAccountId;
    ...
    console.error('POST /api/patient-auth/messages/upload error:', error);
